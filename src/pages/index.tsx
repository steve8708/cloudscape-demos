...
const demos = [
  ...
  { route: '/network-admin-dashboard', title: 'Network Administration Dashboard', description: 'Network traffic, credit usage, and device management dashboard.', category: 'Dashboards' },
  {
